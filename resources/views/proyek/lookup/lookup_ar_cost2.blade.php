...
<script>
    function pilih(row){
        ...
        var l_kd_cost2=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("l_kd_cost2").value = l_kd_cost2;

        var cost_activity2=row.cells[4].innerHTML;
        window.opener.parent.document.getElementById("cost_activity2").value = cost_activity2;

        var cost2=row.cells[5].innerHTML;
        window.opener.parent.document.getElementById("cost2").value = cost2;

        var volume2=row.cells[6].innerHTML;
        window.opener.parent.document.getElementById("volume2").value = volume2;

        var cost_extend2=row.cells[7].innerHTML;
        window.opener.parent.document.getElementById("cost_extend2").value = cost_extend2;

        var total_cost2=row.cells[8].innerHTML;
        window.opener.parent.document.getElementById("total_cost2").value = total_cost2;
