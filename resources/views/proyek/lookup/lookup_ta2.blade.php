...
<td colspan="5">
  <form class="navbar-form" action="{{ url('/proyek/lookup/lookup_ta2/') }}" method="GET"  >
...
<script>
    function pilih(row){
        ...
        var ta2=row.cells[0].innerHTML;
        window.opener.parent.document.getElementById("ta2").value = ta2;
        var nama_ta2=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("nama_ta2").value = nama_ta2;
var email_ta2=row.cells[2].innerHTML;
        window.opener.parent.document.getElementById("email_ta2").value = email_ta2;            
 window.close();
    }
</script>
