...
<script>
    function pilih(row){
        ...
        var l_kd_cost4=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("l_kd_cost4").value = l_kd_cost4;

        var cost_activity4=row.cells[4].innerHTML;
        window.opener.parent.document.getElementById("cost_activity4").value = cost_activity4;

        var cost4=row.cells[5].innerHTML;
        window.opener.parent.document.getElementById("cost4").value = cost4;

        var volume4=row.cells[6].innerHTML;
        window.opener.parent.document.getElementById("volume4").value = volume4;

        var cost_extend4=row.cells[7].innerHTML;
        window.opener.parent.document.getElementById("cost_extend4").value = cost_extend4;

        var total_cost4=row.cells[8].innerHTML;
        window.opener.parent.document.getElementById("total_cost4").value = total_cost4;
