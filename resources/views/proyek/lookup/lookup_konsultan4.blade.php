...
<td colspan="5">
  <form class="navbar-form" action="{{ url('/proyek/lookup/lookup_konsultan4') }}" method="GET"  >
...
<script>
    function pilih(row){
        ...
        var konsultan4=row.cells[0].innerHTML;
        window.opener.parent.document.getElementById("konsultan4").value = konsultan4;
        var nama_konsultan4=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("nama_konsultan4").value = nama_konsultan4;
        var email_konsultan4=row.cells[2].innerHTML;
        window.opener.parent.document.getElementById("email_konsultan4").value = email_konsultan4;    
