...
<td colspan="5">
  <form class="navbar-form" action="{{ url('/proyek/lookup/lookup_konsultan5') }}" method="GET"  >
...
<script>
    function pilih(row){
        ...
        var konsultan5=row.cells[0].innerHTML;
        window.opener.parent.document.getElementById("konsultan5").value = konsultan5;
        var nama_konsultan5=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("nama_konsultan5").value = nama_konsultan5;
        var email_konsultan5=row.cells[2].innerHTML;
        window.opener.parent.document.getElementById("email_konsultan5").value = email_konsultan5;    
