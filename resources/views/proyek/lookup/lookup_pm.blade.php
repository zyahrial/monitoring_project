<body>
    ...
    <table class="table table-bordered table-hover" style="font-size:12px; color: black;"><td colspan="5">
  <form class="navbar-form" action="{{ url('/proyek/lookup/lookup_pm') }}" method="GET"  >
...
<script>
    function pilih(row){
        ...
        var pm=row.cells[0].innerHTML;
        window.opener.parent.document.getElementById("pm").value = pm;
        var pm_name=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("pm_name").value = pm_name;
        var pm_email=row.cells[2].innerHTML;
        window.opener.parent.document.getElementById("pm_email").value = pm_email;
