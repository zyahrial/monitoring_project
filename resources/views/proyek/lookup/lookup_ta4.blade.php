...
<td colspan="5">
  <form class="navbar-form" action="{{ url('/proyek/lookup/lookup_ta4/') }}" method="GET"  >
...
<script>
    function pilih(row){
        ...
        var ta4=row.cells[0].innerHTML;
        window.opener.parent.document.getElementById("ta4").value = ta4;
        var nama_ta4=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("nama_ta4").value = nama_ta4;
var email_ta4=row.cells[2].innerHTML;
        window.opener.parent.document.getElementById("email_ta4").value = email_ta4;            
 window.close();
    }
</script>
