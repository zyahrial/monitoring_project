<body>
    @include('partials/header3') 
          <div class="col-lg-12 bg-aqua" style="padding : 20px;">
            ...
            <section class="panel">
                <div class="panel-heading bg-primary" style="margin-left:10px; margin-right: 10px; ">Budget Cost List</div>
...
<script>
    function pilih(row){
        ...
        var l_kd_cost3=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("l_kd_cost3").value = l_kd_cost3;

        var cost_activity3=row.cells[4].innerHTML;
        window.opener.parent.document.getElementById("cost_activity3").value = cost_activity3;

        var cost3=row.cells[5].innerHTML;
        window.opener.parent.document.getElementById("cost3").value = cost3;

        var volume3=row.cells[6].innerHTML;
        window.opener.parent.document.getElementById("volume3").value = volume3;

        var cost_extend3=row.cells[7].innerHTML;
        window.opener.parent.document.getElementById("cost_extend3").value = cost_extend3;

        var total_cost3=row.cells[8].innerHTML;
        window.opener.parent.document.getElementById("total_cost3").value = total_cost3;
