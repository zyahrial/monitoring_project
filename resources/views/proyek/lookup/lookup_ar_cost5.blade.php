...
<script>
    function pilih(row){
        ...
        var l_kd_cost5=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("l_kd_cost5").value = l_kd_cost5;

        var cost_activity5=row.cells[4].innerHTML;
        window.opener.parent.document.getElementById("cost_activity5").value = cost_activity5;

        var cost5=row.cells[5].innerHTML;
        window.opener.parent.document.getElementById("cost5").value = cost5;

        var volume5=row.cells[6].innerHTML;
        window.opener.parent.document.getElementById("volume5").value = volume5;

        var cost_extend5=row.cells[7].innerHTML;
        window.opener.parent.document.getElementById("cost_extend5").value = cost_extend5;

        var total_cost5=row.cells[8].innerHTML;
        window.opener.parent.document.getElementById("total_cost5").value = total_cost5;
