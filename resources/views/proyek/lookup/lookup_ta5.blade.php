...
<script>
    function pilih(row){
        ...
        var ta5=row.cells[0].innerHTML;
        window.opener.parent.document.getElementById("ta5").value = ta5;
        var nama_ta5=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("nama_ta5").value = nama_ta5;
var email_ta5=row.cells[2].innerHTML;
        window.opener.parent.document.getElementById("email_ta5").value = email_ta5;            
 window.close();
    }
</script>
