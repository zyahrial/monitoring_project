...
<td colspan="5">
  <form class="navbar-form" action="{{ url('/proyek/lookup/lookup_konsultan1') }}" method="GET"  >
...
<script>
    function pilih(row){
        ...
        var konsultan1=row.cells[0].innerHTML;
        window.opener.parent.document.getElementById("konsultan1").value = konsultan1;
        var nama_konsultan1=row.cells[1].innerHTML;
        window.opener.parent.document.getElementById("nama_konsultan1").value = nama_konsultan1;
        var email_konsultan1=row.cells[2].innerHTML;
        window.opener.parent.document.getElementById("email_konsultan1").value = email_konsultan1;    
