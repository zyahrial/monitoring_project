...
<button class="btn btn-sm btn-raised btn-success" onChange="form.submit()">Cari</button>
    ...
    <th style="border-right-color:#; width: 5%;"><strong>MULAI/SELESAI</strong></td>
      ...
      <th style="border-right-color:#; width: 15%;"><strong>JASA</strong></td>
            ...
            <th ><strong>NILAI KONTRAK</strong><br><text style="font-size: 7px; color: red; width: 7%; ">SEBELUM PAJAK</text></td>
            <th style="border-right-color:#; width: 5%;"><strong>PAJAK</strong></td>
            <th ><strong>TOTAL NILAI</strong><br><text style="font-size: 7px; color: red; width: 7%;">SETELAH PAJAK</text></td>
...
<strong>Rp. {{ @$finclude_nilai }}</strong>
          ...
          <td  ><span style="padding: 5px; border-radius: 3px;" class="bg-yellow">Berjalan </span></td>
          @elseif ($data->proyek_status == "open")
          <td  ><span style="padding: 5px; border-radius: 3px;" class="bg-green">Berjalan </span></td>
          @endif
   </tbody> 
   </tr>
      </div>
