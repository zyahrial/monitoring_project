...
<i class="fa fa-arrow-circle-left" title="BACK TO BASE" style="font-size: 32px;"></i> </a></div>
<div class="panel-heading bg-primary" style="margin-left:10px; margin-right: 10px; ">Tambah Tagihan</div>
<div class="panel-body" style="margin-left:10px; margin-right: 10px; width: 50%;">
<form action="{{ action('Prj_terminController@store', $data->kd_proyek) }}" method="post" class="form" align="left">
      {{ csrf_field() }}      
...
<input type="text" class="form-control" name="kode_ib" id="kode_ib" autocomplete="off" readonly="readonly" value="{{ old('kode_ib') }}">
...
<label for="exampleInputEmail1">ID ACTIVITY :</label>
    <input type="text" class="form-control" name="kd_activity" id="kd_activity" readonly="readonly" value="{{ old('activity') }}">
<br>
<div style="padding: 5px; border: 1px solid black; ">
    <label for="exampleInputEmail1"> TANGGAL PELAKSANAAN SETELAH :</label><br>
        <label for="exampleInputEmail1"> KEGIATAN</label>
                    ...
                    <input type="text" class="form-control" name="date" id="date" readonly="readonly" value="{{ old('date') }}">
</div>
@foreach ($proyek as $data)
...
<input type="number" class="form-control" name="revenue_percent" id="revenue_percent"  value="{{ old('revenue_percent') }}">
...
<div class='input-group date' >
          <select  name="termin_ke" class="form-control" value="{{ old('termin_ke') }}">
            <option value="" class="bg-aqua">-PILIH-</option>
...
<input type="text" class="form-control" name="kd_mdi" id="kd_mdi" value="{{ old('kd_mdi') }}">

<label for="exampleInputEmail1">NOMOR ORDER :</label>
<input type="text" class="form-control" name="no_order" id="no_order" value="{{ old('no_order') }}">
...
<input name="tgl_sertifikat" id="tgl_sertifikat" class="input-group datepicker form-control" date="" data-date-format="yyyy-mm-dd" type="text"  autocomplete="off" value="{{ old('tgl_sertifikat') }}" id="date" readonly >
<span class="input-group-addon" id="tgl_sertifikat">
<span class="fa fa-calendar"></span></span>
</div>
<label for="exampleInputEmail1">JENIS/JUMLAH KOMODITI :</label>
<input type="text" class="form-control" name="jml_komoditi" id="jml_komoditi" value="{{ old('jml_komoditi') }}">
<br>
...
<div class='input-group date' style="width: 70%; margin-top: 5px">
<input class="form-control" type="number" name="tarip_unit" value="{{ old('tarip_unit') }}"
...
<div class='input-group date' style="width: 70%; margin-top: 5px">
<input class="form-control" type="number" name="biaya_analisa" value="{{ old('biaya_analisa') }}"
...
<div class='input-group date' style="width: 70%; margin-top: 5px">
<input class="form-control" type="number" name="materai" value="{{ old('materai') }}"
...
<div class='input-group date' style="width: 70%; margin-top: 5px">
<input class="form-control" type="number" name="lain_lain" value="{{ old('lain_lain') }}"
...
<div class='input-group date' style="width: 70%; margin-top: 5px">
<input class="form-control" type="number" name="potongan" value="{{ old('potongan') }}"
...
<input type="hidden" name="admin" id="kode">
...
<input type="text" class="form-control" style="width: 50%; padding-top: 5px;" id="email" readonly="readonly" placeholder="">
<input type="text" class="form-control" style="width: 50%; padding-top: 5px;" id="jabatan" readonly="readonly"  placeholder="">
<br>
</div>
     <button type="submit" class="btn btn-sm btn-raised btn-primary">Simpan</button>
          ...
          @endforeach
<br>
<div class="panel-heading bg-primary" style="margin-left:10px; margin-right: 10px; ">Daftar Tagihan</div><div class="panel-body" style="margin-left:10px; margin-right: 10px; ">
