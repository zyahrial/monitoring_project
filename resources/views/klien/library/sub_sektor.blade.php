  ...
  <body>
    ...
    <div class="row">
          <div class="col-lg-6">
            <section class="panel">
              <div class="panel-heading" style="margin-left:10px; margin-right: 10px; ">Tambah Sub Sektor</div>
      <div class="panel-body" style="margin-left:10px; margin-right: 10px; ">
              ...
              <div class="panel-heading" style="margin-left:10px; margin-right: 10px; ">Pilih Sub Sektor</div>
      <div class="panel-body" style="margin-left:10px; margin-right: 10px; ">       
