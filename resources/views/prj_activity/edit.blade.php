...
@foreach($dt as $dta)
    <div class="row">
          <div class="col-lg-12">
            <section class="panel">
                <div class="panel-heading bg-primary" style="margin-left:10px; margin-right: 10px; ">Update Activity</div>
<div class="panel-body" style="margin-left:10px; margin-right: 10px; ">
<form action="{{ action('Prj_activityController@update', $dta->kd_activity) }}"  method="post" enctype="multipart/form-data">
{{ csrf_field() }}  
<input name="_method" type="hidden" value="PATCH">        
              <div class="form-group">
                    <input type="hidden" class="form-control" name="kd_activity" id="kd_activity" value="{{ $dta->kd_activity}}" hidden="true">
                    <label for="exampleInputEmail1">Activity :</label>
                     <input type="text" class="form-control" name="activity" id="activity" value="{{ $dta->activity}}">
                     <label for="exampleInputEmail1">Sub Activity :</label>
                    <input type="text" class="form-control" name="sub_activity" id="sub_activity" value="{{ $dta->sub_activity}}">
...
<table class="table table-bordered table-hover" style="font-size:12px; color: black;">
    <tbody>
      <tr>
            ...
            <td rowspan="2"><strong>COST ACTIVITY</strong></td>
            <tr>
